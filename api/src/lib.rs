...
use dataloaders::{
    ...
    MetadataJsonAttributesLoader, MetadataJsonLoader, ProjectCollectionsLoader,
...
pub struct AppContext {
    ...
    project_collection_loader: DataLoader<ProjectCollectionsLoader>,
