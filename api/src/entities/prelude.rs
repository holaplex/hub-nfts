...
pub use super::{
    ...
    metadata_json_files::Entity as MetadataJsonFiles,
    metadata_json_jobs::Entity as MetadataJsonJobs,
    metadata_json_uploads::Entity as MetadataJsonUploads, metadata_jsons::Entity as MetadataJsons,
