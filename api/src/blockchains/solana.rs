...
//     > for Solana
// {
//     async fn create_open_drop(
//         &self,
//         key: NftEventKey,
//         payload: MetaplexMasterEditionTransaction,
//     ) -> Result<()> {
//         let event = NftEvents {
//             event: Some(SolanaCreateOpenDrop(payload)),
//         };
...
//     async fn retry_create_open_drop(
//         &self,
//         key: NftEventKey,
//         payload: MetaplexMasterEditionTransaction,
//     ) -> Result<()> {
//         let event = NftEvents {
//             event: Some(SolanaRetryOpenDrop(payload)),
//         };
...
//     async fn update_open_drop(
//         &self,
//         key: NftEventKey,
//         payload: MetaplexMasterEditionTransaction,
//     ) -> Result<()> {
//         let event = NftEvents {
//             event: Some(SolanaUpdateOpenDrop(payload)),
//         };
...
//     async fn mint_open_drop(
//         &self,
//         key: NftEventKey,
//         payload: MintMetaplexMetadataTransaction,
//     ) -> Result<()> {
//         let event = NftEvents {
//             event: Some(SolanaMintOpenDrop(payload)),
//         };
...
//     async fn retry_mint_open_drop(
//         &self,
//         key: NftEventKey,
//         payload: MintMetaplexMetadataTransaction,
//     ) -> Result<()> {
//         let event = NftEvents {
//             event: Some(SolanaRetryMintOpenDrop(payload)),
//         };
