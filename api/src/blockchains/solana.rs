...
use crate::proto::{
    nft_events::Event::{
        ...
        SolanaRetryMintToCollection, SolanaTransferAsset, SolanaUpdateCollection,
        SolanaUpdateCollectionMint, SolanaUpdateDrop,
    },
    ...
    > for Solana
{
    ...
    async fn update_collection_mint(
        ...
        let event = NftEvents {
            event: Some(SolanaUpdateCollectionMint(payload)),
        };
